...
// Comprehensive seed data using only existing database fields
const listings = [
  {
    title: 'Stunning Victorian House in Richmond',
    description: 'A beautiful Victorian house with modern amenities, perfect for families. Features include period details, spacious rooms, and a private garden with mature trees. Recently renovated kitchen and bathrooms.',
    price: 850000,
    bedrooms: 4,
    bathrooms: 3,
    receptions: 2,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1568605114967-8130f3a36994', caption: 'Beautiful Victorian exterior', isMain: true },
      { url: 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e', caption: 'Modern fitted kitchen', isMain: false },
      { url: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2', caption: 'Spacious living room', isMain: false },
      { url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7', caption: 'Master bedroom', isMain: false },
      { url: 'https://images.unsplash.com/photo-1507652313519-d4e9174996dd', caption: 'Private garden', isMain: false },
    ],
  ...
  },
  {
    ...
    description: 'An exceptional penthouse apartment with panoramic city views, concierge service, and premium amenities. Located in the heart of Mayfair with easy access to Hyde Park and world-class shopping.',
    price: 1200000,
    bedrooms: 2,
    bathrooms: 2,
    receptions: 1,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1464983953574-0892a716854b', caption: 'Luxury living room with city views', isMain: true },
      { url: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb', caption: 'Master bedroom suite', isMain: false },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136', caption: 'Designer kitchen', isMain: false },
      { url: 'https://images.unsplash.com/photo-1571055107559-3e67626fa8be', caption: 'Private terrace', isMain: false },
    ],
    floor_plan: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd',
  ...
  },
  {
    ...
    description: 'A delightful seaside cottage just minutes from the beach. Perfect for holiday lets or a peaceful coastal lifestyle. Recently renovated with modern comforts while maintaining original character features.',
    price: 350000,
    bedrooms: 2,
    bathrooms: 1,
    receptions: 1,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae', caption: 'Charming cottage exterior', isMain: true },
      { url: 'https://images.unsplash.com/photo-1484154218962-a197022b5858', caption: 'Cozy living space', isMain: false },
      { url: 'https://images.unsplash.com/photo-1556909114-4f6e4d1a938c', caption: 'Compact kitchen', isMain: false },
    ],
    floor_plan: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd',
  ...
  },
  {
    ...
    description: 'A contemporary 3-bedroom house in a popular family area. Features include open-plan living, fitted kitchen, and private driveway. Perfect for growing families with excellent local schools nearby.',
    price: 275000,
    bedrooms: 3,
    bathrooms: 2,
    receptions: 1,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9', caption: 'Modern exterior', isMain: true },
      { url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7', caption: 'Open-plan living', isMain: false },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136', caption: 'Fitted kitchen', isMain: false },
      { url: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85', caption: 'Family bathroom', isMain: false },
    ],
    floor_plan: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd',
  ...
  },
  {
    ...
    description: 'A stunning period townhouse in the heart of Bath. This Grade II listed property combines historical character with modern comfort and style. Features original period details throughout.',
    price: 650000,
    bedrooms: 3,
    bathrooms: 2,
    receptions: 2,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1613977257363-707ba9348227', caption: 'Georgian facade', isMain: true },
      { url: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2', caption: 'Period living room', isMain: false },
      { url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7', caption: 'Master bedroom', isMain: false },
      { url: 'https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e', caption: 'Period kitchen', isMain: false },
    ],
    floor_plan: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd',
  ...
  },
  {
    ...
    description: 'A unique loft-style apartment in a converted Victorian warehouse. Features exposed brick walls, high ceilings, and industrial-style windows. Perfect for city living with character.',
    price: 425000,
    bedrooms: 1,
    bathrooms: 1,
    receptions: 1,
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688', caption: 'Industrial loft living', isMain: true },
      { url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7', caption: 'Open-plan bedroom area', isMain: false },
      { url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136', caption: 'Modern kitchen', isMain: false },
    ],
    floor_plan: 'https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd',
...
async function seedListings() {
  try {
    ...
    console.log(`Created ${listings.length} comprehensive property listings with rich data.`);
  } catch (error) {
